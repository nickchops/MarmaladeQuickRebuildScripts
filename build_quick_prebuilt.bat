...
quick_prebuilt.mkb --buildenv=VC10X  --no-ide --make --compiler=gcc --mips --output-name=target/android/mips/quick_prebuilt --output-name-debug=target/android/mips/quick_prebuilt_d
